"""Terminal UI utilities for singleangle skill."""
...
MINI_BANNER = f"""{Colors.PURPLE}{Colors.BOLD}/singleangle{Colors.RESET} {Colors.DIM}· researching...{Colors.RESET}"""
...
{Colors.YELLOW}⚡ UNLOCK THE FULL POWER OF /singleangle{Colors.RESET}
...
{Colors.DIM}Setup:{Colors.RESET} Edit {Colors.BOLD}~/.config/singleangle/.env{Colors.RESET}
{Colors.YELLOW}{Colors.BOLD}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{Colors.RESET}
"""

PROMO_MESSAGE_PLAIN = """
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
⚡ UNLOCK THE FULL POWER OF /singleangle
...
Setup: Edit ~/.config/singleangle/.env
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
"""
...
PROMO_SINGLE_KEY = {
    "reddit": f"""
{Colors.DIM}💡 Tip: Add {Colors.YELLOW}OPENAI_API_KEY{Colors.RESET}{Colors.DIM} to ~/.config/singleangle/.env for Reddit data with real engagement metrics!{Colors.RESET}
""",
    "x": f"""
{Colors.DIM}💡 Tip: Add {Colors.CYAN}XAI_API_KEY{Colors.RESET}{Colors.DIM} to ~/.config/singleangle/.env for X/Twitter data with real likes & reposts!{Colors.RESET}
""",
}

PROMO_SINGLE_KEY_PLAIN = {
    "reddit": "\n💡 Tip: Add OPENAI_API_KEY to ~/.config/singleangle/.env for Reddit data with real engagement metrics!\n",
    "x": "\n💡 Tip: Add XAI_API_KEY to ~/.config/singleangle/.env for X/Twitter data with real likes & reposts!\n",
}
...
class ProgressDisplay:
    ...
    def _show_banner(self):
        if IS_TTY:
            ...
            sys.stderr.write(f"/singleangle · researching: {self.topic}\n")
        sys.stderr.flush()
